                ...
                <div
                    ...
                    <div
                        ...
                        <form action="#" class="space-y-4 px-4 py-6">
                            ...
                            <div
                                class="flex flex-col md:flex-row items-center md:space-x-3">
                                <button
                                    type="button"
                                ...
                                <button
                                    ...
                                    <svg
                                        class="text-gray-600 w-4 transform -rotate-45"
                        ...
                        <form action="#" class="space-y-4 px-4 py-6">
                            ...
                            <div>
                                <textarea name="update_comment"
                                    id="update_comments" cols="30" rows="3"
                                    class="w-full text-sm bg-gray-100 rounded-xl placeholder-gray-900 border-none px-4 py-2"
                            ...
                            <div>
                                <label
                                    class="font-normal inline-flex items-center">
                                    <input type="checkbox" name="notify_voters"
                                        class="rounded bg-gray-200" checked>
