<div
    ...
    var target = clicked.tagName.toLowerCase();
    var ignores = ['button', 'svg', 'path', 'a'];
    ...
    <div class="hidden md:block border-r border-gray-100 px-5 py-8">
        ...
        <div class="mt-8">
            ...
            <button
                ...
                class="w-20 text-white bg-blue border border-blue hover:bg-blue-hover font-bold text-xxs uppercase rounded-xl transition duration-150 ease-in px-4 py-3">Voted</button>
    ...
    <div class="flex flex-col md:flex-row flex-1 px-2 py-6">
        ...
        <div class="w-full flex flex-col justify-between mx-2 md:mx-4">
            ...
            <div
                class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                <div
                ...
                <div class="flex items-center md:hidden mt-4 md:mt-0">
                    <div
                        class="bg-gray-100 text-center rounded-xl h-10 px-4 py-2 pr-8">
                        <div
