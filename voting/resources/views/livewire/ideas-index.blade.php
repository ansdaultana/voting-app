<div>
    <div
        class="filters flex flex-col md:flex-row space-y-3 md:space-y-0 md:space-x-6">
    ...
    <div class="ideas-container space-y-6 my-8">
        ...
        <div class="mx-auto w-70 mt-12">
            <img src="{{ asset('image/no-ideas.svg') }}" alt="No Ideas"
                class="mx-auto" style="mix-blend-mode: luminosity">
            <div class="text-gray-400 text-center font-bold mt-6">No ideas were
                found...</div>
        </div>
        @endforelse
    </div>
