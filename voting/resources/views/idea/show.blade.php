<x-app-layout>
    <div>
        <a href="{{ $backUrl }}"
            ...
            <span class="ml-2">All ideas (or back to chosen category with
                filters)</span>
        </a>
    </div>
            ...
            <div class="flex flex-col md:flex-row flex-1 px-4 py-6">
                ...
                <div class="w-full md:mx-4">
                    {{-- <h4 class="text-xl font-semibold">
                        <a href="#" class="hover:underline">A random title can
                            go here</a>
                    </h4> --}}
            ...
            {{-- <div
                ...
                <div class="flex flex-1 px-4 py-6">
                    <div class="flex-none">
                        ...
                        <div
                            class="text-center uppercase text-blue text-xxs font-bold mt-1">Admin</div>
                    </div>
                    <div class="w-full mx-4">
                        <h4 class="text-xl font-semibold">
                            <a href="#" class="hover:underline">Status Changed
                                to "Under Consideration"</a>
                        </h4>
                        <div class="text-gray-600 mt-3 line-clamp-3">
                            Lorem ipsum dolor sit amet consectetur.
                        </div>
