...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link
            href="https://fonts.bunny.net/css?family=Open+Sans:400,500,600&display=swap"
            rel="stylesheet" />
    ...
    <body class="font-sans bg-gray-background text-gray-900 text-sm">
        <header
            ...
            <a href="/">
                <img class="h-7 w-25" src="{{ asset('image/profile.png')}}">
            </a>
            ...
            <div class="w-70 mx-auto md:mx-0 md:mr-5">
                <div
                    ...
                    <div class="text-center px-6 py-2 pt-6">
                        ...
                        @else
                        <p class=" text-base">Please login to create an idea!</p>
                        @endauth
                    </div>
                    @auth
                    ...
                    <div class="my-6 text-center">
                        ...
                        <a
                            href="{{route('register')}}"
                            class="mt-4 inline-block justify-center w-1/2 h-11 text-xs bg-gray-200 font-semibold rounded-xl border border-gray-200 hover:border-gray-400 transition duration-150 ease-in px-6 py-3">
                            Sign Up
                        </a>
                    </div>
                    @endauth
